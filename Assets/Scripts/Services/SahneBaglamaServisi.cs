...
public class SahneBaglamaServisi
{
    ...
    public interface IBaglamaHedefi
    {
        ...
        TMP_Text BonusOyunKazancText { get; set; }
    ...
    public void BindIfNeeded(Transform root, IBaglamaHedefi target)
    {
        ...
        if (target.BonusOyunKazancText == null)
            target.BonusOyunKazancText = FindTmpByNameContains(root, "BonusOyunKazancText", "Bonus Oyun Kazanc");
