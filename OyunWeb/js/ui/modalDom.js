  ...
  return new Promise((coz) => {
    ...
    kutu.innerHTML = `
      <div style="display:flex;justify-content:space-between;align-items:center;
        border-bottom:1px solid rgba(212,162,74,.3);padding-bottom:10px;margin-bottom:16px">
        <span style="color:#d4a24a;font-weight:700;letter-spacing:2px;font-size:18px">${baslik}</span>
        <span style="color:#8a94a8;font-size:16px">${sayfa}</span>
      </div>
      <div>${govdeHtml}</div>
